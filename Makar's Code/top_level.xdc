...
# # pmoda[0]
# set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[1]" ]
# # pmoda[1]
# set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[3]" ]
# # pmoda[2]
# set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[5]" ]
# # pmoda[3]
# set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[7]" ]
# # pmoda[4]
# set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[0]" ]
# # pmoda[5]
# set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[2]" ]
# # pmoda[6]
# set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[4]" ]
# # pmoda[7]
# set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33}  [ get_ports "camera_d[6]" ]


set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33}  [ get_ports "pmodb[0]" ]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33}  [ get_ports "lidar_out_raw"]
...
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {servo[3]}]
